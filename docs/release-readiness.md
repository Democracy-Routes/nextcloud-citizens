...
| 4 | Run the full test suite | **Done** — 362 Python and 188 frontend tests pass, plus 5 browser tests in the separate pre-release suite; lint clean, store schema validation passes. |
