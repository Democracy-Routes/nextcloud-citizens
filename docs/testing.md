...
Roughly: 319 Python tests, 174 frontend tests, 5 browser tests. The first two
gate every commit and take about ten minutes together; the browser suite is
another seven and runs before a release.
